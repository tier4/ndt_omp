...
public:
  ...
  void set_min_res(double min_level_res) {
    min_level_res_ = min_level_res;
  }
  ...
  void set_max_bucket_scan_count(int max_bucket_scan_count) {
    max_bucket_scan_count_ = max_bucket_scan_count;
  }

  double get_min_res() const {
    return min_level_res_;
  }
  ...
  int get_max_bucket_scan_count() const {
    return max_bucket_scan_count_;
  }
